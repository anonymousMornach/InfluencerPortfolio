    ...
    <div>
      <div className="hero bg-light">
        <div className="container text-center py-5">
          <h1 className="display-4">About Chanel Best</h1>
          <p className="lead">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <h2>Background</h2>
              <p className="lead">
                Chanel Best was born and raised in Los Angeles, California. She
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <p className="lead">
                ...
                International Photography Award for Best Landscape Photographer
