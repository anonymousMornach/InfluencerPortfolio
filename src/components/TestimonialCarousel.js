      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          <div className="testimonial">
            <p className="quote">
              "Chanel's photography is truly breathtaking. She has an eye for
        ...
        <div className="carousel-item">
          <div className="testimonial">
            <p className="quote">
              "Working with Chanel was a pleasure from start to finish. She has
        ...
        <div className="carousel-item">
          <div className="testimonial">
            <p className="quote">
              "Chanel's photography has a unique quality that makes her work
